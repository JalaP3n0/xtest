      ...
      <div className="form-card glass" style={{ width: '100%', maxWidth: '480px' }}>
        <div className="brand" style={{ justifyContent: 'center', marginBottom: '40px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', lineHeight: 1.1, textAlign: 'left' }}>
            ...
            <span style={{ fontSize: '0.6rem', letterSpacing: '1px', color: 'var(--muted)', fontWeight: 700 }}>STAFF PORTAL</span>
          </div>
        </div>
        
        <div style={{ textAlign: 'center', marginBottom: '48px' }}>
          <p className="eyebrow" style={{ color: 'var(--muted)', letterSpacing: '4px' }}>Usher Access</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="button" style={{ marginTop: '32px', width: '100%', height: '54px' }} disabled={loading}>
            {loading ? 'Verifying...' : 'Log In to Profile'}
          </button>
        </form>

        <div style={{ marginTop: '40px', textAlign: 'center', fontSize: '0.85rem', color: 'var(--muted)', letterSpacing: '0.5px' }}>
          Want to join the team? <Link href="/signup/usher" style={{ color: 'var(--accent)', fontWeight: 700, textTransform: 'uppercase', fontSize: '0.75rem', marginLeft: '8px' }}>Apply as Usher</Link>
        </div>
      </div>
    </main>
  );
